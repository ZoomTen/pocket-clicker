...
macro homeProc*(node: untyped): untyped =
  codeGenMacro("NONBANKED")

macro bankedProc*(node: untyped): untyped =
  codeGenMacro("BANKED")

macro oldCall*(node: untyped): untyped =
  codeGenMacro("__sdcccall(0)")

macro newCall*(node: untyped): untyped =
  codeGenMacro("__sdcccall(1)")
